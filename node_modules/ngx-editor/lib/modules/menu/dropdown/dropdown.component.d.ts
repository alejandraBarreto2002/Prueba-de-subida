...
export declare class DropdownComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DropdownComponent, "ngx-dropdown", never, { "group": { "alias": "group"; "required": false; }; "items": { "alias": "items"; "required": false; }; }, {}, never, never, true, never>;
}
